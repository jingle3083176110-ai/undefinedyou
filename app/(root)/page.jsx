...
export default function HomePage() {
	...
	return (
		<FullPageWrapper className="bg-cream">
			...
			<Section><section className="flex min-h-screen w-full items-center bg-cream px-8 py-24 md:px-24"><div className="mx-auto grid w-full max-w-7xl gap-12 md:grid-cols-[.72fr_1.28fr]"><div><SectionMark number="03" label={t("writing.label")} /><h2 className="mt-6 font-serif text-5xl leading-[1.04] tracking-normal text-ink md:text-7xl">{t("home.studiesTitle")}</h2><p className="mt-7 max-w-sm leading-7 text-muted">{t("home.studiesSummary")}</p><div className="mt-10"><QuietLink href="/writing">{t("home.collections")}</QuietLink></div></div><div className="grid gap-px border border-ink/20 bg-ink/20 md:grid-cols-2"><Link href="/writing/technology" className="group min-h-72 bg-cream p-7 transition-colors hover:bg-[#f0ece3]"><p className="font-mono text-[10px] uppercase tracking-[.2em] text-muted">01 / {t("writing.technology")}</p><h3 className="mt-16 font-serif text-4xl tracking-normal text-ink transition-transform group-hover:translate-x-2">{t("writing.technology")}</h3><p className="mt-4 text-sm leading-6 text-muted">{t("writing.technologySummary")}</p></Link><Link href="/writing/literature" className="group min-h-72 bg-cream p-7 transition-colors hover:bg-[#f0ece3]"><p className="font-mono text-[10px] uppercase tracking-[.2em] text-muted">02 / {t("writing.literature")}</p><h3 className="mt-16 font-serif text-4xl tracking-normal text-ink transition-transform group-hover:translate-x-2">{t("writing.literature")}</h3><p className="mt-4 text-sm leading-6 text-muted">{t("writing.literatureSummary")}</p></Link></div></div></section></Section>

...
const courseDetails = {
  ...
  GEW1001: {
    institution: "The Chinese University Of Hong Kong (shenzhen)",
    instructor: "Prof. Wen Jiang",
    description: "本课程致力于引导学生成为一个有理想信念、有道德意识和法治意识的合格公民。通过将课程理论与学生的日常生活联系在一起，探讨与学生生活息息相关的道德修养问题、法治问题，帮助学生获得切实的学习及生活指导，树立正确的世界观与人生观。同时，在了解世界、了解社会、了解中国发展的过程中，促使学生形成更强的责任意识，更加关心社会发展问题，关心中国的命运与前途。",
  },
  MAT1001: {
    institution: "The Chinese University Of Hong Kong (shenzhen)",
...
export const courseTerms = [
  ...
  },
  {
    ...
    courses: [
      ...
      course("GEW2000", "Introduction to Marxism", "Year1%20Term2/GEW2000"),
